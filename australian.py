# -*- coding: utf-8 -*-
"""
Created on Wed Aug 14 12:44:49 2019
...
#        mlp_rej.cuda()
        ...
        scheduler_class = StepLR(optimizer, step_size=1000, gamma=0.5)
        scheduler_rej = StepLR(optimizer_rej, step_size=1000, gamma=0.5)
        c=01.00#2.250#.50#370#0.15
#        epsilon=1.0
        beta=1#/(1-2*c)
        alpha=2#1.0
...
#            1/0
        ...
        print("accuracy with top 24 rejected=",a_r)
